export const projects = [
  {
    slug: "rocketdrop-ecommerce",
    title: "Rocketdrop E-commerce Platform",
    description:
  ...
  },
  {
    ...
    featured: true,
    longDescription:
      "This project involved creating a sophisticated analytics dashboard capable of processing and visualizing complex data sets. It features interactive charts, customizable reports, and robust internationalization support, including full Right-to-Left (RTL) layouts for languages like Arabic, as seen in the dashboard interface. Built with React and Next.js, it leverages D3.js for powerful data visualization and integrates with various REST APIs for data fetching. The focus was on delivering actionable insights through a highly responsive and user-friendly interface, catering specifically to diverse linguistic and cultural needs.",
  },
  {
    slug: "digitalkonnect-marketplace",
    title: "Digital Konnect - UK Community Marketplace",
    description:
    ...
    longDescription:
      "Developed a complete pixel-perfect website from scratch, by translating UI/UX design wireframes into reusable code components. Developed responsive web pages and email templates that are optimized for various devices and screen sizes, enhancing usability across desktops, tablets, and mobile devices. Received 100% positive client feedback and appreciation for delivering high-quality, user-focused design solutions that exceeded project expectations even before deadlines.",
  },
  {
    slug: "ihunt-outdoor-platform",
    title: "iHunt - Outdoor & Hunting Platform",
    description:
  ...
  },
  {
    ...
    title: "Teeny Coders - Educational Platform",
    description:
    ...
    featured: true,
    longDescription:
      "Developed an engaging and interactive online coding platform designed for school kids from Grades 1-12. The platform aims to foster coding, mathematical, and problem-solving skills through advanced programming technologies. It features a user-friendly interface, curriculum details, course offerings, and a 'Book Free Class' option. Built with Next.js and React, and styled with Tailwind CSS, the project focuses on delivering a revolutionary educational experience in a global online school setting.",
  },
  {
    slug: "zenbench-dashboard",
    title: "ZenBench - Dashboard Development",
    description:
