...
import { ExternalLink, Github, ArrowLeft, Download, Menu, X, Linkedin } from "lucide-react"
      ...
      <div className="min-h-screen bg-background text-foreground overflow-x-hidden relative">
        ...
        <div className="relative z-10">
          ...
          <section className="py-20 px-4 sm:px-6 lg:px-8 pt-32">
            <div className="max-w-7xl mx-auto bg-card border border-border rounded-2xl p-8 lg:p-12">
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
                <Link href="/projects" passHref>
                  <Button variant="ghost" className="text-foreground/70 hover:text-accent-blue">
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
                <h1 className="text-4xl lg:text-5xl font-bold text-foreground mb-6">{project.title}</h1>
                <p className="text-xl text-foreground/70 leading-relaxed mb-8">{project.description}</p>

                <div className="relative rounded-lg overflow-hidden mb-8 border border-border">
                  <img
